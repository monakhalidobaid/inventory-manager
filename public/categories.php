...
<body class="department-page">
    ...
    <main class="main-content">
        ...
        <section class="add-department-section">
            ...
            <div class="add-department-form">
                ...
                <div class="form-group">
                    <label for="cat_name" style="font-weight: 500;">Category Name</label>
                    <br>
                    <input id="cat_name" name="cat_name" type="text" placeholder="Enter department name" required>
        ...
        <section class="departments-list-section">
            ...
            <table class="transactions-table"  id="catTable">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>Category Name</th>
...
<div id="editModal" class="modal">
  <div class="modal-content">
    ...
    <h3 class="form-header">Edit Category</h3>
    <hr style="border: 1px solid rgb(241, 234, 234);">

    <form id="editCatForm">
      <div class="form-group">
        <label for="edit_cat_name">Category Name</label>
        <input type="text" id="edit_cat_name" name="edit_cat_name" required>
...
<div id="deleteModal" class="modal">
  <div class="modal-content">
    <h3 class="form-header">⚠️ Delete Category</h3>
    <hr style="border: 1px solid rgb(241, 234, 234);">
